...
(function (Expressions) {
    ...
    function isNotNullExpr(value, index) {
        ...
        return lexer_1.default.tokenize(value, start, index, `"${fieldName}" IS NOT NULL`, lexer_1.default.TokenType.IsNotNullExpression);
    }
    ...
    function isNullExpr(value, index) {
        ...
        return lexer_1.default.tokenize(value, start, index, `"${fieldName}" IS NULL`, lexer_1.default.TokenType.IsNullExpression);
    }
    ...
    function isNullOrEmptyExpr(value, index) {
        ...
        return lexer_1.default.tokenize(value, start, index, `( "${fieldName}" IS NULL OR "${fieldName}" = '' )`, lexer_1.default.TokenType.IsNullOrEmtpyExpression);
    }
