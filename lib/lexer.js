...
(function (TokenType) {
    ...
    TokenType["JsonPathExpression"] = "JsonPathExpression";
    TokenType["AndExpression"] = "AndExpression";
    TokenType["OrExpression"] = "OrExpression";
    TokenType["IsNullExpression"] = "IsNullExpression";
    TokenType["IsNullOrEmtpyExpression"] = "IsNullOrEmptyExpression";
    TokenType["IsNotNullExpression"] = "IsNotNullExpression";
    ...
    TokenType["InExpression"] = "InExpression";
    ...
    TokenType["MethodCallJsonExpression"] = "MethodCallJsonExpression";
...
(function (Lexer) {
    ...
    -------------------------------------------------------------------------------- */
    // A-Z,a-z, >=- 80
    function ALPHA(value) { return (value >= 0x41 && value <= 0x5a) || (value >= 0x61 && value <= 0x7a) || value >= 0x80 || value === 0x3c || value === 0x3e || value === 0x2d; } //  ;
    Lexer.ALPHA = ALPHA;
    ...
    function pcharNoSQUOTE(value, index) {
        if (Lexer.unreserved(value[index]) || value[index] === 0x24 || value[index] === 0x26 || value[index] === 0x23)
            return index + 1;
        else
